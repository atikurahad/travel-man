            ...
            <div className="flex  ">
              <div className="flex-row mt-6">
                ...
                <p className="text-2xl text-gray-900">
                  <span className="text-black font-bold">USD$</span> 1500 </p>
                <div className="flex">
             ...
             <div className="mt-10">
            <button className="border-2 border-solid border-gray-500 m-2 p-3  text-3xl text-center font-mono hover:bg-gray-700 hover:text-white">{<MailOutlineIcon color="error" fontSize="large" />}Enquire Now</button>
            <button className="m-2 p-3 border-solid border-2 border-gray-500 text-3xl text-center font-mono hover:bg-green-200"> <span className="">{<RemoveRedEyeIcon color="secondary" fontSize="large" />}</span> View Offer</button>
          </div>
          </article>
       ...
       <div className="bg-[#F4F4F4] mx-[10rem] mt-5 mb-5 max-w-[1240px]">
        <div className="grid grid-cols-2  justify-items-center	">
          ...
          <article className="mt-5 ">
            ...
            <h1 className="text-4xl font-bold">Food and Wine Indulgence in Adelaide</h1>
            ...
            <div className="flex  ">
              <div className="flex-row mt-6">
                ...
                <p className="text-2xl text-gray-900">
                  <span className="text-black font-bold">USD$</span> 1280 </p>
                <div className="flex">
                  <img src={tag} className="h-8" alt="" />
